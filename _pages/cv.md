...
**Project Leadership, Oversight, and Management**

* Provided agile-based project management forecasting and leadership to meet deadlines and priorities of operational and strategic objectives
* Coordinated and led multiple, simultaneous projects while engaging with stakeholder groups including team collaborators, advisory board members, researchers, and members of the GLAM community
* Prepared annual project reports for funding partner including a progress summary, identified the status of milestones, deliverables, and goals, and visual infographics to highlight impact factors

**Scholarly Support + Resources**

* Coordinated and supported cohort program, which provided mentorship and engagement with international scholars exploring web archival data
* Collaboratively designed multi-media educational resources to support scholarly research and skill-building
* Tested and supported access to project user documentation

**Community Engagement**

* Initiated and cultivated an online presence for information sharing, community building, and engagement
* Co-designed project website; regularly updated, reviewed and contributed to structure, visuals, and content; and conducted evaluations of accessibility compliance
* Collaborated on over a dozen journal articles, publications, conference presentations, and workshops to encourage and support discussion within the web archiving ecosystem
* Facilitated the planning and hosting of in-person (4) and virtual (2) learning events in partnership with academic research institutions in Canada and the US

**UX Testing**

* Iterative wireframe sketching; transformed sketches into semi-functional interactive prototypes
* Designed and conducted iterative rounds of User Experience (UX) testing among stakeholder groups to understand user needs, research workflows, and assess accessibility compliance
* Collected and summarized qualitative and quantitative data, presented findings to project team to inform development cycles
* Led the development and implementation of documentation, which included functional steps of using a new product, technical details, case studies, and tutorial-based resources

**Community Engagement Manager**, [Social Media Lab](https://socialmedialab.ca), Ryerson University, 2013-2016

* Scripted, edited and published over a dozen instructional video tutorials and education materials to support teaching and learning with social media data
* Developed workshops for academic researchers on social media data training, specifically the Netlytic platform
* Engaged with visiting scholars and Netlytic users torecommend solutions, tools and methodologies to support research strategies
* Designed, implemented and maintained documentation
* Conducted assessment of project website content and assets, redesigning documentation to ensure accurate information and efficient workflow
* Created and implemented social media strategy to increase community engagement and share data literacy resources

**Research Manager**, Private Startup, 2015 - 2017

* Deployed monitoring dashboard for project charter, goals, deliverables
* Created and maintained digital repository of project-based assets
* Provided one-on-one support and teaching for literature searches and information retrieval on multi-subject research projects
* Applied records management practices to over 500 digital and textual documents to assist in effective information retrieval
* Applied privacy policy practices to 750 surveys to ensure proper security measures of personal information
* Analyzed, reported, and visualized quantitative and qualitative data for workshop, conference, and publication materials

**Interim Project and Community Manager**, [Islandora Foundation](https://islandora.ca), 2014

* Coordinated logistics, promotion and outreach of international workshops
* Initiated and implemented standardization of business documents
* Oversaw administrative functions and provided representation on committees and working groups
* Created and maintained a records management program for electronic documents and folders
* Provided outreach and support to current and new clients
* Maintained social media presence to engage members and affiliated organizations
* Maintained, updated, and created content for Drupal-based website, including various blog posts and the integration of a community calendar

**Reference and Research Intern**, [Killiam Memorial Library](https://libraries.dal.ca), Dalhousie University, 2013-2014

* Provided virtual and in-person research support to library patrons from several faculties, including Business, Science, Information Management, Humanities, Social Work, and Environmental Studies.
* Liaised with students, faculty, and broader Halifax community to assist in search strategies, tool learning, and resource training
* Conducted one-on-one tutorials on using online catalogues, electronic databases, e-books, print and web-based resources
* Reviewed and updated e-resources, including subject guides, digital repository entries, and catalogued bibliographic information
